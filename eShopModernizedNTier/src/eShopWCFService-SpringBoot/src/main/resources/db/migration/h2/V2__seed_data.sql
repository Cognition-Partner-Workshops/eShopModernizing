...
-- Stock entries
INSERT INTO catalog_items_stock (stock_id, catalog_item_id, date, available_stock) VALUES (1, 1, DATE '2017-09-20', 100);
INSERT INTO catalog_items_stock (stock_id, catalog_item_id, date, available_stock) VALUES (2, 1, DATE '2017-09-21', 120);
INSERT INTO catalog_items_stock (stock_id, catalog_item_id, date, available_stock) VALUES (3, 1, DATE '2017-09-22', 80);
INSERT INTO catalog_items_stock (stock_id, catalog_item_id, date, available_stock) VALUES (4, 2, DATE '2017-09-20', 45);
INSERT INTO catalog_items_stock (stock_id, catalog_item_id, date, available_stock) VALUES (5, 4, DATE '2017-09-25', 65);
INSERT INTO catalog_items_stock (stock_id, catalog_item_id, date, available_stock) VALUES (6, 5, DATE '2017-09-28', 22);

-- Discount items
INSERT INTO discount_items (id, size, start_date, end_date) VALUES (1, 0.3, DATE '2017-09-18', DATE '2017-09-21');
INSERT INTO discount_items (id, size, start_date, end_date) VALUES (2, 0.25, DATE '2017-09-22', DATE '2017-09-26');
INSERT INTO discount_items (id, size, start_date, end_date) VALUES (3, 0.1, DATE '2017-09-27', DATE '2017-09-30');
INSERT INTO discount_items (id, size, start_date, end_date) VALUES (4, 0.5, DATE '2017-10-05', DATE '2017-10-20');
INSERT INTO discount_items (id, size, start_date, end_date) VALUES (5, 0.3, DATE '2017-11-13', DATE '2017-11-25');
INSERT INTO discount_items (id, size, start_date, end_date) VALUES (6, 0.25, DATE '2017-12-20', DATE '2017-12-25');
