...
/// <summary>
/// Edit/create form model for a catalog item. Replaces the individual Web Forms
/// <c>TextBox</c>/<c>DropDownList</c> controls and their validators
/// (<c>RequiredFieldValidator</c>/<c>RangeValidator</c>) with a single bound
/// model carrying the same fields, bounds and validation messages.
/// </summary>
