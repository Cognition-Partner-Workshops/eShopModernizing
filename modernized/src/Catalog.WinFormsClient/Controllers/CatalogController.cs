...
namespace eShopWinForms.Controllers
{
    public class CatalogController
    {
        ...
        private ICatalogClient _service;
        private ICatalogView _view;

        public CatalogController(ICatalogClient service, ICatalogView view)
        {
        ...
        private void addAvailability(ICatalogView view, AvailabilityEventArgs e)
        {
            ...
            shipment.Date = Timestamp.FromDateTime(DateTime.SpecifyKind(e.shipDate, DateTimeKind.Utc));
        ...
        private void CheckForDiscounts()
        {
            ...
            if (discount != null)
            {
                ...
                String bannerText = String.Format("{0}% sale endson {1}!", discountPercentage.ToString(), discount.End.ToDateTime().ToShortDateString());
