...
/// <summary>
/// The legacy <c>eShopLegacyMVC.Tests.PreconfiguredDataTests</c> MSTest suite ported to xunit;
/// this is the seed data the catalog list renders in mock-data mode.
/// </summary>
