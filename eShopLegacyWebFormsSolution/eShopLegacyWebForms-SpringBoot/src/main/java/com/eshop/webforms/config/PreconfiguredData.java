...
public final class PreconfiguredData {
    ...
    public static List<CatalogItem> getCatalogItems() {
        return List.of(
                ...
                createItem(3, 2, 5, "Prism White T-Shirt", "Prism White T-Shirt", new BigDecimal("12"), "3.png", 100),
                createItem(4, 2, 2, ".NET Foundation T-shirt", ".NET Foundation T-shirt", new BigDecimal("12"), "4.png", 100),
                createItem(5, 3, 5, "Roslyn Red Sheet", "Roslyn Red Sheet", new BigDecimal("8.50"), "5.png", 100),
                createItem(6, 2, 2, ".NET Blue Hoodie", ".NET Blue Hoodie", new BigDecimal("12"), "6.png", 100),
                createItem(7, 2, 5, "Roslyn Red T-Shirt", "Roslyn Red T-Shirt", new BigDecimal("12"), "7.png", 100),
                createItem(8, 2, 5, "Kudu Purple Hoodie", "Kudu Purple Hoodie", new BigDecimal("8.50"), "8.png", 100),
                createItem(9, 1, 5, "Cup<T> White Mug", "Cup<T> White Mug", new BigDecimal("12"), "9.png", 100),
                createItem(10, 3, 2, ".NET Foundation Sheet", ".NET Foundation Sheet", new BigDecimal("12"), "10.png", 100),
                createItem(11, 3, 2, "Cup<T> Sheet", "Cup<T> Sheet", new BigDecimal("8.50"), "11.png", 100),
                createItem(12, 2, 5, "Prism White TShirt", "Prism White TShirt", new BigDecimal("12"), "12.png", 100)
        );
    }
