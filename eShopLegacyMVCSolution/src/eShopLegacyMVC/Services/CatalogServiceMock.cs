...
namespace eShopLegacyMVC.Services
{
    public class CatalogServiceMock : ICatalogService
    {
        ...
        public PaginatedItemsViewModel<CatalogItem> GetCatalogItemsPaginated(int pageSize = 10, int pageIndex = 0, string searchText = null, int? brandId = null, int? typeId = null)
        {
            ...
            {
                items = items.Where(c => c.Name.Contains(searchText));
            }
